...
with open('best_roc.txt','w') as f:
    f.write('Best model: '+best_model+'\n')
    f.write(f'ROC area {max_area}')

with open('analysis/bottle/bottle_best_roc.txt','w') as f:
    f.write('Best bottle model: '+best_bottle_model+'\n')
    f.write(f'ROC area {max_area_bottle}')

with open('analysis/funnel/funnel_best_roc.txt','w') as f:
    f.write('Best funnel model: '+best_funnel_model+'\n')
    f.write(f'ROC area {max_area_funnel}')

with open('analysis/constant/constant_best_roc.txt','w') as f:
    f.write('Best constant model: '+best_constant_model+'\n')
