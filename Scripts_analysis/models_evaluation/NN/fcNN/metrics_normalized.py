...
list_bottle_models=os.listdir('/home/private/Hepd/Dataset_4/fcNN/normalized/bottle')
arch='bottle'
...
prel_dir='/home/private/Hepd/Dataset_4/fcNN/normalized/bottle/bottle_depth_'
rocs=[]
train_loss=[]
validation_loss=[]
...
for depth in depths:
    ...
    plt.savefig('/home/private/Hepd/Dataset_4/analysis/normalized/bottle/losses/depths/losses_depth_'+str(depth)+'.png')
    plt.close()
    ...
    plt.savefig('/home/private/Hepd/Dataset_4/analysis/normalized/bottle/rocs/depths/rocs_depth_'+str(depth)+'.png')
    plt.close()
...
for layer in layers:
    ...
    plt.ylabel('Loss Value')
    plt.legend()
    plt.title('Train Test Validation Loss with last layer of '+str(layer)+' neurons ofbottle models')
    plt.savefig('/home/private/Hepd/Dataset_4/analysis/normalized/bottle/losses/layers/losses_layer_'+str(layer)+'.png')
    plt.close()
    ...
    plt.savefig('/home/private/Hepd/Dataset_4/analysis/normalized/bottle/rocs/layers/rocs_layer_'+str(layer)+'.png')
    plt.close()
...
list_funnel_models=os.listdir('/home/private/Hepd/Dataset_4/fcNN/normalized/funnel/')
arch='funnel'
...
#### PLOTTIAMO LE ROC E LE LOSS PER LAYER COSTANTE ####
prel_dir='/home/private/Hepd/Dataset_4/fcNN/normalized/funnel/funnel_depth_'
rocs=[]
train_loss=[]
validation_loss=[]
for depth in depths:
    ...
    plt.savefig('/home/private/Hepd/Dataset_4/analysis/normalized/funnel/losses/depths/losses_depth_'+str(depth)+'.png')
    plt.close()
    ...
    plt.savefig('/home/private/Hepd/Dataset_4/analysis/normalized/funnel/rocs/depths/rocs_depth_'+str(depth)+'.png')
    plt.close()
...
for layer in layers:
    ...
    plt.savefig('/home/private/Hepd/Dataset_4/analysis/normalized/funnel/losses/layers/losses_layer_'+str(layer)+'.png')
    plt.close()
    ...
    plt.savefig('/home/private/Hepd/Dataset_4/analysis/funnel/rocs/layers/rocs_layer_'+str(layer)+'.png')
    plt.close()


#### CREIAMO I PLOT DELLE LOSS AL VARIARE DI PROFONDITà E LARGHEZZA DI PRIMO E ULTIMO LAYER DEI CONSTANT MODELS ####

list_constant_models=os.listdir('/home/private/Hepd/Dataset_4/fcNN/normalized/constant/')
arch='constant'
...
#### PLOTTIAMO LE ROC E LE LOSS PER LAYER COSTANTE ####
prel_dir='/home/private/Hepd/Dataset_4/fcNN/normalized/constant/constant_depth_'
rocs=[]
train_loss=[]
validation_loss=[]
for depth in depths:
    ...
    plt.savefig('/home/private/Hepd/Dataset_4/analysis/normalized/constant/losses/depths/losses_depth_'+str(depth)+'.png')
    plt.close()
    ...
    plt.savefig('/home/private/Hepd/Dataset_4/analysis/normalized/constant/rocs/depths/rocs_depth_'+str(depth)+'.png')
    plt.close()
...
for layer in layers:
    ...
    plt.savefig('/home/private/Hepd/Dataset_4/analysis/normalized/constant/losses/layers/losses_layer_'+str(layer)+'.png')
    plt.close()
    ...
    plt.savefig('/home/private/Hepd/Dataset_4/analysis/normalized/constant/rocs/layers/rocs_layer_'+str(layer)+'.png')
    plt.close()