...
for arch in archs:
    path='/home/private/Hepd/Dataset_4/fcNN/normalized/'+arch
    ...
    ### Plottiamo le predictions per Elettroni e Protoni ###
        ...
        plt.yscale('log')
        plt.title('Predictions model normalized '+model+' over Test set')
        ...
        plt.title('ROC model normalized '+model+' over Test set')
        plt.legend()
        ...
        plt.title('Training and Validation Loss model normalized '+model)
        plt.xlabel('Epochs')
        plt.ylabel('Loss')
        plt.legend()
        ...
        plt.title('Training and Validation Accuracy model normalized '+model)
        plt.xlabel('Epochs')
        plt.ylabel('Accuracy')
        plt.legend()
