...
test_generator_wLabels=MyGenerator_wLables('/home/private/Hepd/Dataset_4/test/test_norm_data','/home/private/Hepd/Dataset_4/test/test_labels',pca=False,input_dimension=40)

### QUESTO VA DATO A model.evaluate CHE VALUTA LE PRESTAZIONI SUL TRAIN-SET ###
train_generator_wLabels=MyGenerator_wLables('/home/private/Hepd/Dataset_4/train/train_norm_data','/home/private/Hepd/Dataset_4/train/train_labels',pca=False,input_dimension=40)

### QUESTO VA DATO A model.evaluate CHE VALUTA LE PRESTAZIONI SUL VALIDATION-SET ###
validation_generator_wLabels=MyGenerator_wLables('/home/private/Hepd/Dataset_4/validation/validation_norm_data','/home/private/Hepd/Dataset_4/validation/validation_labels',pca=False,input_dimension=40)

### QUESTO VA DATA A model.predict CHE PREDICE UN RISULTATO PER OGNI EVENTO NEL TEST-SET ###

test_generator_jData=MyGnerator_jData('/home/private/Hepd/Dataset_4/test/test_norm_data',pca=False,input_dimension=40)
...
models=os.listdir('/home/private/Hepd/Dataset_4/fcNN_ResNet/normalized_ResNet/bottle_ResNet')
#models=os.listdir('/home/private/Hepd/Dataset_4/fcNN_ResNet/normalized_ResNet/funnel_ResNet')
#models=os.listdir('/home/private/Hepd/Dataset_4/fcNN_ResNet/normalized_ResNet/constant_ResNet')
...
for model in models:
    ...
    if model[0]=='b':
        architecture='bottle_ResNet'
    elif model[0]=='f':
        architecture='funnel_ResNet'
    elif model[0]=='c':
        architecture='constant_ResNet'
    elif model[0]=='g':
        architecture='general_ResNet'

    
    models_dir.append('/home/private/Hepd/Dataset_4/fcNN_ResNet/normalized_ResNet/'+architecture+'/'+model)
